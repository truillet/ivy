# Utiliser sra5
**[sra5](https://github.com/truillet/ivy/blob/master/agents/sra5.zip)** est un agent ivy fonctionnant sous OS Windows utilisant le moteur de reconnaissance natif SAPI 5.x de Windows Vista, 7, 8.1 ou 10 et peut renvoyer deux types de solutions issues de la reconnaissance sous deux formats différents : sous forme de séquence orthographique ou sous forme de concepts.
